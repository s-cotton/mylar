...
def IssueCovers(ComicID=None):
    if mylar.ENABLE_COVER_COMPOSITION:
            ...
            if comic is None:
                ...
                for issue in issues:
                    ...
                    if cover != "notfound":
                        ...
                        nocovers = []
                        coverfile.append( nocovers )
                    else :
                        for coveroffset in range(0, covercount):
                            issuecovers.append( os.path.join(mylar.CACHE_DIR, 'temp-cover-' + coveroffset + '.jpg') )
                        coverfile.append( issuecovers )

                maxIssues = len(coverfile)
                maxCovers = 0;
        ...
        logger.fdebug("Well, you didn't enable Cover View...")
