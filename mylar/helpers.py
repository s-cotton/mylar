...
def IssueCovers(ComicID=None):
    if mylar.ENABLE_COVER_COMPOSITION:
        ...
        # Regexes to help with identifying Covers
            ...
            if comic is None:
                ...
                for issue in issues:
                    ...
                    try:
                        if rawfilename.endswith('.cbz'):
                            ...
                            if mylar.ENABLE_RAR:
                                ...
                                logger.fdebug('RAR File Processing is not Enabled, skipping issue...')
                                continue
                        loaded_archive = True
                    except:
                        logger.fdebug('ERROR. Could not open ' + rawfilename + ' for cover extraction: ' + str(sys.exc_info()))
                    ...
                    if loaded_archive:
                        ...
                        logger.fdebug("Found " + str(len(cover_filenames)) + " raw covers...")
                        ...
                        logger.fdebug("Found " + str(len(final_cover_filenames)) + " covers...")
                        ...
                        if len(final_cover_filenames) > 0:
                            ...
                            for cover_filename in sorted(final_cover_filenames):
                                logger.fdebug('Extracting cover: ' + cover_filename)
